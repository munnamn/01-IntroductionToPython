...
#
###############################################################################
perch = rg.SimpleTurtle()

perch.pen = rg.Pen('blue', 10)
perch.speed = 7
perch.forward(200)
perch.right = (10)

perch.pen = rg.Pen('green', 20)
perch.backward(75)
perch.left(100)

reth = rg.SimpleTurtle('turtle')
reth.pen = rg.Pen('blue', 10)
reth.speed = 3
reth.backward(200)
reth.right = (10)

reth.pen = rg.Pen('green', 20)
reth.forward(75)
reth.left(100)
###############################################################################
#
